...
class CashRegisterTest {
    private val register: CashRegister = CashRegister() // empty register
    ...
    fun testPutBills() {
        ...
        assertEquals(expected = 7, actual = register.tens, message = "After adding 1 bill to the tens, register should have 7 twenties")
        assertEquals(expected = 8, actual = register.fives, message = "After adding 1 bill to the fives, register should have 8 fives")
        assertEquals(expected = 9, actual = register.twos, message = "After adding 1 bill to the twos, register should have 9 twos")
        assertEquals(expected = 10, actual = register.ones, message = "After adding 1 bill to the ones, register should have 10 ones")
    }

    @org.junit.Test
    fun testTakeBills() {
        val bills = arrayOf(1, 2, 3, 4, 5)
        register.take(bills)
